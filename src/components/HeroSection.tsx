      ...
      <div className="max-w-6xl mx-auto px-6 text-center">
        <div className="animate-gentle-fade">
          <img
            ...
            className="w-full max-w-2xl h-auto mx-auto mb-8 rounded-2xl shadow-glow hover:scale-105 transition-transform duration-500"
          />
        </div>

        <div className="space-y-6 animate-smooth-rise">
